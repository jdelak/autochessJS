...
function addRedDot(){
	...
	if((playerTopCase[carre].className == 'redlvl2') || (playerTopCase[carre].className == 'redlvl3')){
		playerTopCase[carre].classList.remove('redlvl1');
		carre = carre+1;
	}else if(playerTopCase[carre].className =='redlvl1'){
		carre = carre+1;
	}
